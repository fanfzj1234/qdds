...
<div class="container">
<a href="__APP__">首页</a>>>大学联盟
<div id="info_list_main">
    <ul>
      <?php if(is_array($qd_alliance)): foreach($qd_alliance as $key=>$qd_alliance): ?><li><a href="__APP__/Show/show_qd_alliance?Id=<?php echo ($qd_alliance["Id"]); ?>"><?php echo ($qd_alliance["Title"]); ?></a>  
      <span><?php echo ($qd_alliance["Time"]); ?></span>
      </li>
