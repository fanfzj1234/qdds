...
<div class="container">
  <a href="__APP__">首页</a>>>创业培训列表
  <div id="info_list_main">
    <?php
 $count = count($ds_practices); if($count){ ?>
    <ul>
    <ul>
      <?php if(is_array($ds_practices)): foreach($ds_practices as $key=>$ds_practice): ?><li><a href="__APP__/Show/show_ds_practice?Id=<?php echo ($ds_practice["id"]); ?>"><?php echo ($ds_practice["theme"]); ?></a>  
      <span><?php echo ($ds_practice["publish_time"]); ?></span>
      </li>
