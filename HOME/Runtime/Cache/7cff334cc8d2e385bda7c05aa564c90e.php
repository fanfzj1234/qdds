...
<div class="container">
 ...
 $count = count($club_activities); if($count){ ?>
    <ul>
      <?php if(is_array($club_activities)): foreach($club_activities as $key=>$club_activitiy): ?><li><a href="__APP__/Show/show_activity?Id=<?php echo ($club_activitiy["Id"]); ?>"><?php echo ($club_activitiy["theme"]); ?></a>  
      <span><?php echo ($club_activitiy["datetime"]); ?></span>
      </li>
