 ...
 <div class="modal hide fade" id="login-win" role="dialog">
			  ...
			  <div class="controls">
				  <input type="text" id="check" />
				   <input type="button" id="checkCode" class="code" style="width:60spx" onClick="setCode()" name="checkCode"/> 
				   <a href="#" onClick="setCode()">看不清楚</a>
		          </div>
		       </div> 		   
		   <!--
              ...
              <div class="modal-footer">
                    <a href="#myModal" type="button" data-toggle="modal" data-dismiss="modal" class="btn btn-primary" id="to-register">现在注册</a>
...
<div class="container">
<a href="__APP__">首页</a>>>齐大资讯
<div id="info_list_main">
   <?php
 $count=count($qd_news); if($count){ ?>
    <ul>
      <?php if(is_array($qd_news)): foreach($qd_news as $key=>$qd_news): ?><li><a href="__APP__/Show/show_qd_news?Id=<?php echo ($qd_news["Id"]); ?>"><?php echo ($qd_news["theme"]); ?></a>  
      <span><?php echo ($qd_news["setup_time"]); ?></span>
      </li>
