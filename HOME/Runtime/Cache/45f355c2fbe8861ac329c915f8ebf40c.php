...
<div class="container">
  <a href="__APP__">首页</a>>>社团活动召集列表
  <div id="info_list_main">
   <?php
 $count = count($taobao_marketings); if($count){ ?>
    <ul>
      <?php if(is_array($taobao_marketings)): foreach($taobao_marketings as $key=>$taobao_marketing): ?><li><a href="__APP__/Show/show_taobao_marketing?Id=<?php echo ($taobao_marketing["Id"]); ?>"><?php echo ($taobao_marketing["theme"]); ?></a>  
      <span><?php echo ($taobao_marketing["fb_time"]); ?></span>
      </li>
