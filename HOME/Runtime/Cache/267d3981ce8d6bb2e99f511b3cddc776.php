    ...
    <div id="topnav">
      <ul>
        ...
        <li><a href="#">网上创业技能</a>
         ...
         <li><a href="__ROOT__/dianshang/Forum/upload/forum.php" target="_blank">电子商务论坛</a>
         <li><a href="#">课程｜毕业设计</a>
...
<div class="container">
  <a href="__APP__">首页</a>>>优惠政策列表
  <div id="info_list_main">
   <?php
 $count = count($club_activities); if($count){ ?>
    <ul>
      <?php if(is_array($ds_consults)): foreach($ds_consults as $key=>$ds_consult): ?><li><a href="__APP__/Show/show_ds_consult?Id=<?php echo ($ds_consult["Id"]); ?>"><?php echo ($ds_consult["name"]); ?></a>  
      <span style="float:right"><?php echo ($ds_consult["fb_time"]); ?></span>
      </li>
     <HR style="FILTER: alpha(opacity=100,finishopacity=0,style=1)" width="100%" color=#987cb9 SIZE=3><?php endforeach; endif; ?>
    </ul>
     <?php
 } else{ echo "没有找到相关内容"; } ?>
  </div>
