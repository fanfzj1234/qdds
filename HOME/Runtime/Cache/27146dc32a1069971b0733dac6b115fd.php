...
<div class="container">
 <a href="__APP__">首页</a>>>创业培训信息
<div id="info_main" class="wrapper col8">
    <div id="header"><h2><?php echo $ds_consults['name']; ?></h2></div>
    <div id="info_content">
     <?php
 echo $ds_consults['content'] ?>
    </div>
    <div id="footer" style="margin-top:30px;"><div><?php echo $ds_consults['fb_time'] ?></div><div></div>
</div>
</div>
